...
temp_payment = Pay_By_Card()
airline = Airline("KNNS-Airways")
passenger = Platinum("P1234","John","abcd@gmail.com", luggage_weight=60)
booking = Booking("ABC123",passenger,"ABC","Business")
card = Card("1234-5678-9101-1121",10000)
transaction = Transaction("Booking",10000,temp_payment)
